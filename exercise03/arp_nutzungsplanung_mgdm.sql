...
(
  INSERT INTO arp_npl_ch.geobasisdaten_typ_kt
    (
      acode,
      bezeichnung,
      abkuerzung,
  ...
  FROM
    ...
    LEFT JOIN 
      arp_npl_ch.hauptnutzung_ch_hauptnutzung_ch AS hn
      ON 
...
(
  SELECT 
    nextval('arp_npl_ch.t_ili2db_seq'::regclass) AS t_id,
...
(
  INSERT INTO arp_npl_ch.geobasisdaten_typ
    (
      t_id,
      acode,
      bezeichnung,
...
(
  INSERT INTO arp_npl_ch.geobasisdaten_grundnutzung_zonenflaeche
    (
      t_id,
      publiziertab,
      rechtsstatus,
  ...
  FROM
    ...
    (
      SELECT 
        t_id
      FROM
        arp_npl_ch.hauptnutzung_ch_hauptnutzung_ch
      WHERE
        acode = 69
    ) AS hn
    ON 
...
(
  INSERT INTO arp_npl_ch.geobasisdaten_ueberlagernde_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
...
(
  INSERT INTO arp_npl_ch.geobasisdaten_linienbezogene_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
...
(
  INSERT INTO arp_npl_ch.geobasisdaten_objektbezogene_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
